        ...
        <div class='container'>
            <div class='row p-3' style='background-color:#ffffff;'>
                <div class='col-md-8' style='padding-right:0px;padding-left:0px;'>
                    <ul class="nav nav-tabs pt-2" style="border-bottom:0px;" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Challanges</button>
                        </li>
                        <li class="nav-item" role="presentation">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 px-5">
                    <h2 class='text-white'><img src='<?php echo $colors['logo'];?>' style='max-width: 180px !important;padding-right:20px;border-right:3px solid #ffffff;margin-right:20px' alt='Logo'><b id='header'></b></h2>
                </div>
            </div>
        </div>
    </nav>
                        ...
                        <div class="tab-content" id="myTabContent" style='background-color:#f3f3f3;'>
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <div class="row" style='border-bottom:1px solid #dee2e6;'>
                                    ...
                                    <div class="col-md-4 p-2" style="justify-content:right;display:flex;">
                                        <select id='filter' style='padding:6px;border:1px solid #dee2e6;background-color:#f3f3f3;color:#7d7b7b;width:180px;font-size:14px;'>
