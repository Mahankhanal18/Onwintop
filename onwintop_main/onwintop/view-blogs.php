                            ...
                            <div id="page-contents" class="row merged20">
                                <div class="col-lg-12">
                                    <div class="main-wraper blank-wrapper">
                                        <div class="main-title">All Blogs</div>
                                        <div class='row wrapper'>
                                            <div class='col-md-12 mb-3' style="display:inline">
                                                    <h6 onclick="window.location='<?php URL('/view-blogs');?>'" style="float:left;font-weight:500;border-bottom:3px solid #000000;">All</h6>
                                                    <h6 onclick="window.location='<?php URL('/pending-blogs');?>'" style="float:left;margin-left:20px;font-weight:500">To be published</h6>
                                            </div>
                                        </div>
                                        <div class="row wrapper">
                                            <?php
                                            $c = "SELECT * FROM `blogs` WHERE `community_id`='" . $_SESSION['community_id'] . "' ORDER BY `id` DESC ";
