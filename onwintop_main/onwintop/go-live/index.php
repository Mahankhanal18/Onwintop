 ...
 */
$OAUTH2_CLIENT_ID = '953504763280-3lf4ojtumdffoaj8gnlnvk8obnj825op.apps.googleusercontent.com';
$OAUTH2_CLIENT_SECRET = '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';
...
if ($client->getAccessToken()) {
    try {
        ...
        $broadcastSnippet->setScheduledStartTime($time);
        $broadcastSnippet->setScheduledEndTime($time);
