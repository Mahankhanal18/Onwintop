...
if($cred['role']=='Admin'){
    $challenges_submitted=R::findAll('challengesubmissions','community_link=? AND status=? ORDER BY id DESC',[$community_id,'Rewarded']);
}else{
    $challenges_submitted=R::findAll('challengesubmissions','community_link=? AND status=? AND member_id=? ORDER BY id DESC',[$community_id,'Rewarded',$cred['id']]);
}
							...
							<div id="page-contents" class="row merged20">
								<div class="col-lg-8 col-md-8">
									<div class="main-wraper wrapper">
										<div class="main-title">Completed Challenges

										</div>
										<h6 class='mb-3'><a href='<?php URL('/challenges/');?>' style='font-weight:500;'>All</a> <a href='<?php URL('/pending-challenges/');?>' class='ml-3'>Waiting</a> <a class='ml-3'><u>Completed</u></a></h6>
										</br>
										<?php
										//$count=count($blogs);
										...
										?>
											<div class="blog-posts mb-3 content-item" style='padding:15px;border-bottom:1px solid #eaeaea;margin-bottom:15px;background-color:#ffffff;border-radius:8px;'>
											    <div class="row">
											        ...
											        <div class='col-md-4'>
											            <span class="badge badge-success"><?php echo $ss['status'];?></span></br>
