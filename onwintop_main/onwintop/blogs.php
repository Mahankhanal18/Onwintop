									...
									<div class="main-wraper wrapper">
										...
										?>
											<div class="blog-posts mb-3 content-item" style='border-bottom:1px solid #eaeaea;padding-bottom:15px'>
												<figure><img src="<?php echo $cover; ?>" style='height:220px;width:400px;object-fit:cover;object-position:center' alt=""></figure>
												<div class="blog-post-meta">
													<ul>
														<li><i class="fa fa-eye" aria-hidden="true"></i><a title="Reads" href="#">0</a></li>
														<li><i class="fa fa-comment" aria-hidden="true"></i></i><a title="comments" href="#">0</a></li>
													</ul>
													<h4 class='single-line'><?php echo $blog['name']; ?></h4>
													<p class='two-line'>
														<?php echo strip_tags($blog['post']); ?>
													</p>
													<span><i class="fa fa-calendar" aria-hidden="true"></i>&nbsp;<?php echo date_format(date_create($blog['date']), 'd M, Y'); ?></span></br>
													<a href="<?php URL("/blog/" . $blog['id']); ?>" style='float:left' title="" class="button primary circle">read more</a>
												</div>
											</div>
										<?php
										}
