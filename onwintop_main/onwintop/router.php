...
/**
 * UB Router
 * Routing interfaces for routing.
 * Use this interface when defining new routes, it's an
 * easy way for the web of the application to recognize your
 * path. This plugin interface does not require you to
...
session_start();
//Modifying to actual URL path if directory exists
$directory=str_replace("/","",$_ENV['subdirectory']);
$directory="/".$directory;




//$_SESSION['rqst_uri']=str_replace($directory,"",$_SERVER['REQUEST_URI']);
...
function setCookieData($key,$val){
...
function route($route, $path_to_include){
  ...
  $request_url = filter_var($_SESSION['rqst_uri'], FILTER_SANITIZE_URL);
