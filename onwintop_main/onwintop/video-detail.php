...
$url_parts=URL_Parts();
//print_r($url_parts);
$s = "SELECT * FROM `videos` WHERE `id`='" . $id . "' AND `community_id`='" . $community_id . "' ";
...
<head>
	<title><?php echo $content['name']; ?> | Videos </title>
											...
											<div class="col-lg-8 col-md-8 col-sm-8">
												<div class="prod-detail">
													...
													<div class="sale-button">
														<a href="#" title="" class="ask-qst main-btn">Play Now</a>
		...
		<div class="new-question-popup">
			<div class="popup">
				...
				<div class="popup-meta">
					...
					<div class="post-new">
						<iframe src='<?php echo $content["url"];?>' style='width:100%;height:400px;border:none'></iframe>
					</div>
				</div>
			</div>
		</div><!-- ask question -->
